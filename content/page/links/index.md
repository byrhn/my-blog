...
links:
  - title: Amazon (Official)
    ...
    website: [https://amzn.to/4je4ZKA](https://amzn.to/4je4ZKA)
    image: amazon-logo.jpg

  - title: Trip.com
    description: Find flexible hotel & flight deals with global coverage.
    website: [https://trip.tpk.mx/pkmHWLTS](https://trip.tpk.mx/pkmHWLTS)
    image: trip-logo.png

  - title: Ekta Travel
    description: Discover offbeat destinations and custom travel packages.
    website: [https://ektatraveling.tpk.mx/qBtRyuIY](https://ektatraveling.tpk.mx/qBtRyuIY)
    image: ekta-logo.png
